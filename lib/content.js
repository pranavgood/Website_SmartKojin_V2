...
// Real logo file — upload smart-kojin-logo.png into public/images/ in the
// repo. Used for the visible header/footer/credibility-strip logo AND the
// schema.org Organization/LocalBusiness structured data (absolute URL
// required there, which is why LOGO is a full https:// path).
export const LOGO = "https://smartkojin.com/images/smart-kojin-logo.png";
export const LOGO_FOOTER = "https://smartkojin.com/images/smart-kojin-logo.png";
